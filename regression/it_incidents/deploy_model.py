"""
Locate the trained model produced by the incident-resolution-regression job
...
predicted = result["inference_results"][0]["resolution_time_minutes_prediction"]
print(f"  Input  : category=software, severity=3, affected=50, team=3, hour=14, biz_hours=1, comments=15")
print(f"  Output : {predicted:.1f} min  ✓")
